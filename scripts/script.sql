...
CREATE TABLE `product` (
  ...
  CONSTRAINT `FKlabq3c2e90ybbxk58rc48byqo` FOREIGN KEY (`product_type_id`) REFERENCES `product_type` (`product_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (4,'2020-01-28 16:53:54.151000','Shiv Parmar',1),(5,'2020-01-28 16:55:25.795000','affiliateUser',2),(6,'2020-01-28 16:56:17.906000','user1',3),(7,'2020-01-28 16:56:23.434000','user2',3);
...
INSERT INTO `user_type` VALUES (1,30,'employee'),(2,10,'affiliate'),(3,0,'normal');
...
-- Dump completed on 2020-01-28 17:41:10
